...
model = load_model('/Data4TB/zhan/mimiciv_hyperlipidemia/hyperlipidemia.h5')

scaler = joblib.load('/Data4TB/zhan/mimiciv_hyperlipidemia/scaler.pkl')  
...
if predicted_icd_code == 0:
    print("Hyperlipidemia: No")
else:
    print("Hyperlipidemia: Yes")
